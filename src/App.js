        ...
        </nav>
        {
          data!==null?
            <>
              ...
              <p className='footer'><a href='https://bhstechie.netlify.app' target={'_blank'} rel="noreferrer">Developed by Balaharisankar</a></p>
            </>
            :
            <main style={{height:"80%",display:"flex",flexDirection:"column",justifyContent:"center",color:"#4A9CED"}}>
